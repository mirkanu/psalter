...
Status: Phase complete — 10 post-deploy UAT bug-fix quick tasks completed, deployed, and verified live via Playwright (round 1: 260712-kd1/kov/lcg/lp9; round 2: 260712-sny/szw/tmm/u4q, 260713-a5b; round 3: 260713-kkg)
Last activity: 2026-07-13 - Completed and verified round-3 quick task 260713-kkg: asymmetric split-leaf sizing (notation slot content-sized/capped at 50%, lyrics absorb remaining space — kills the blank gap that appeared after scroll-hide reflow) + Solfège notation button now always routes to solfege-split (auto-switches layout) instead of graying out on Staff+Inline
