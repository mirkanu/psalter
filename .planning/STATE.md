...
Status: Phase complete — 11 post-deploy UAT bug-fix quick tasks completed and deployed (round 1: 260712-kd1/kov/lcg/lp9; round 2: 260712-sny/szw/tmm/u4q, 260713-a5b; round 3: 260713-kkg, 260713-lf9). 260713-lf9's desktop scrollbar fix verified live via Playwright; its iOS rubber-band fix cannot be verified in this environment — needs a real iOS device.
Last activity: 2026-07-13 - Completed round-3b quick task 260713-lf9: desktop solfège split-leaf now has exactly 1 scrollbar (was 3) — JPG contain-fits within its 50%-capped slot instead of overflowing/scrolling, outer lyrics wrapper de-duplicated. Also clamped scrollTop to the valid range + 4px delta threshold in the mobile scroll-hide handler to stop iOS rubber-band bounce from flickering the hide state (code-verified only, pending real-device confirmation)
