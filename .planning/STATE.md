...
Last activity: 2026-07-15 - Completed quick task 260715-s7b: fixed inline Staff notation mobile lyric misalignment for held-final-note tunes (e.g. St Agnes, Durham / psalm 62) by weighting the mobile w-line syllable split by real note-head count instead of equal token count, restoring 1:1 syllable-to-note mapping. Unit tests/tsc/build all pass; needs real mobile-device visual confirmation post-deploy
...
| 260715-s7b | Fix inline Staff notation mobile lyric misalignment for held-final-note tunes (e.g. St Agnes, Durham / psalm 62): mobile sub-divides phrases at measure boundaries then split syllables by equal token count, cramming syllables onto a lone held final note; now weights the w-line split by each sub-staff's real note-head count, restoring 1:1 syllable-to-note mapping matching desktop | 2026-07-15 | c0362c6 | [260715-s7b-fix-inline-staff-notation-layout-broken-](./quick/260715-s7b-fix-inline-staff-notation-layout-broken-/) — unit tests/tsc/build all pass; needs real mobile-device visual confirmation on /psalms/62 post-deploy |
