...
Plans:
- [x] 04.9.15.1-01-PLAN.md — MOBILE-09: extend the inline-Staff compact-fit gate to phone landscape (Android + iOS)
- [x] 04.9.15.1-02-PLAN.md — MOBILE-10 building blocks: useSwipeGesture hook + StanzaDotIndicator pill + dot-pulse keyframe
- [x] 04.9.15.1-03-PLAN.md — MOBILE-10 integration: wire swipe + dot indicator into SingingView, add swipe tour step (human-verify)
