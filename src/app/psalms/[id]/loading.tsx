...
export default function PsalmDetailLoading() {
  return (
    <div className="relative">
      {/* Top bar skeleton (sticky below global SiteHeader at top-14) */}
      ...
      {/* Sub bar skeleton */}
      <div className="sticky top-[6.5rem] md:top-28 z-20 h-10 md:h-11 bg-muted/60 backdrop-blur border-b">
        <div className="flex items-center gap-2 px-3 h-full">
          <Skeleton className="h-4 w-20 rounded" />
          <Skeleton className="h-4 flex-1 max-w-[180px] rounded" />
        </div>
      </div>
      {/* Notation body skeleton: 100dvh - SiteHeader(56) - topbar(48) - subbar(40) = 144 */}
      <div className="overflow-x-hidden p-4 space-y-3" style={{ height: 'calc(100dvh - 144px)' }}>
